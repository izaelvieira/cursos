...
<head>
  ...
  <title>LILY Cursos | Log in</title>
  ...
  <link rel="stylesheet" href="{{asset('assets/layout_admin/plugins/iCheck/square/blue.css')}}">
...
<body class="hold-transition login-page">
    ...
    <script src="{{asset('assets/layout_admin/plugins/iCheck/icheck.min.js')}}"></script>
</body>
</html>
